var Swiper = function(e, t) {
    ...
    function r() {
        var e = I - G;
        return t.freeMode && (e = I - G), t.slidesPerView > k.slides.length&&!t.centeredSlides && (e = 0), 0 > e && (e = 0), e
    }
    function o() {
        function e(e) {
            var i = new Image;
            i.onload = function() {
                k && void 0 !== k.imagesLoaded && k.imagesLoaded++, k.imagesLoaded === k.imagesToLoad.length && (k.reInit(), t.onImagesReady && k.fireCallback(t.onImagesReady, k))
            }, i.src = e
        }
        var n = k.h.addEventListener, r = "wrapper" === t.eventTarget ? k.wrapper: k.container;
        ...
        if (t.keyboardControl && n(document, "keydown", l), t.updateOnImagesReady) {
            ...
            for (var a = 0; a < k.imagesToLoad.length; a++)
                e(k.imagesToLoad[a].getAttribute("src"))
        }
    }
    function s() {
        ...
        if (t.releaseFormElements) {
            ...
            for (e = 0; e < o.length; e++)
                n(o[e], k.touchEvents.touchStart, h, !0)
        }
        if (t.onSlideClick)
            for (e = 0; e < k.slides.length; e++)
                n(k.slides[e], "click", p);
        if (t.onSlideTouch)
            for (e = 0; e < k.slides.length; e++)
                n(k.slides[e], k.touchEvents.touchStart, u)
    }
    function a() {
        ...
        if (t.releaseFormElements) {
            ...
            for (e = 0; e < r.length; e++)
                n(r[e], k.touchEvents.touchStart, h, !0)
        }
        if (t.preventLinks) {
    ...
    function l(e) {
        ...
        if (!(e.shiftKey || e.altKey || e.ctrlKey || e.metaKey)) {
            if (37 === t || 39 === t || 38 === t || 40 === t) {
                for (var i=!1, n = k.h.getOffset(k.container), r = k.h.windowScroll().left, o = k.h.windowScroll().top, s = k.h.windowWidth(), a = k.h.windowHeight(), l = [[n.left, n.top], [n.left + k.width, n.top], [n.left, n.top + k.height], [n.left + k.width, n.top + k.height]], d = 0; d < l.length; d++) {
                    var p = l[d];
    ...
    function d(e) {
        ...
        if (t.freeMode) {
            ...
            if (o > 0 && (o = 0), o<-r() && (o =- r()), k.setWrapperTransition(0), k.setWrapperTranslate(o), k.updateActiveSlide(o), 0 === o || o===-r())
                return 
        } else (new Date)
            .getTime() - q > 60 && (0 > n ? k.swipeNext() : k.swipePrev()), q = (new Date).getTime();
    ...
    function c(e) {
        if (e.currentTarget)
            k.clickedSlide = e.currentTarget;
        else {
            var i = e.srcElement;
            do {
    ...
    function g(e) {
        if (t.preventLinks && (k.allowLinks=!0), k.isTouched || t.onlyExternal)
            return !1;
        if (t.noSwiping && (e.target || e.srcElement) && v(e.target || e.srcElement))
            return !1;
        if (U=!1, k.isTouched=!0, $ = "touchstart" === e.type, !$ || 1 === e.targetTouches.length) {
            k.callPlugins("onTouchStartBegin"), $ || k.isAndroid || (e.preventDefault ? e.preventDefault() : e.returnValue=!1);
            var i = $ ? e.targetTouches[0].pageX: e.pageX || e.clientX, n = $ ? e.targetTouches[0].pageY: e.pageY || e.clientY;
            k.touches.startX = k.touches.currentX = i, k.touches.startY = k.touches.currentY = n, k.touches.start = k.touches.current = O ? i : n, k.setWrapperTransition(0), k.positions.start = k.positions.current = k.getWrapperTranslate(), k.setWrapperTranslate(k.positions.start), k.times.start = (new Date).getTime(), D = void 0, t.moveStartThreshold > 0 && (K=!1), t.onTouchStart && k.fireCallback(t.onTouchStart, k, e), k.callPlugins("onTouchStartEnd")
        }
    }
    function w(e) {
        if (k.isTouched&&!t.onlyExternal && (!$ || "mousemove" !== e.type)) {
            var i = $ ? e.targetTouches[0].pageX: e.pageX || e.clientX, n = $ ? e.targetTouches[0].pageY: e.pageY || e.clientY;
            if ("undefined" == typeof D && O && (D=!!(D || Math.abs(n - k.touches.startY) > Math.abs(i - k.touches.startX))), "undefined" != typeof D || O || (D=!!(D || Math.abs(n - k.touches.startY) < Math.abs(i - k.touches.startX))), D)
            ...
            if (e.assignedToSwiper=!0, t.preventLinks && (k.allowLinks=!1), t.onSlideClick && (k.allowSlideClick=!1), t.autoplay && k.stopAutoplay(!0), !$ || 1 === e.touches.length) {
                if (k.isMoved || (k.callPlugins("onTouchMoveStart"), t.loop && (k.fixLoop(), k.positions.start = k.getWrapperTranslate()), t.onTouchMoveStart && k.fireCallback(t.onTouchMoveStart, k)), k.isMoved=!0, e.preventDefault ? e.preventDefault() : e.returnValue=!1, k.touches.current = O ? i : n, k.positions.current = (k.touches.current - k.touches.start) * t.touchRatio + k.positions.start, k.positions.current > 0 && t.onResistanceBefore && k.fireCallback(t.onResistanceBefore, k, k.positions.current), k.positions.current<-r() && t.onResistanceAfter && k.fireCallback(t.onResistanceAfter, k, Math.abs(k.positions.current + r())), t.resistance && "100%" !== t.resistance) {
                    ...
                    if (k.positions.current > 0 && (o = 1 - k.positions.current / G / 2, k.positions.current = .5 > o ? G / 2 : k.positions.current * o), k.positions.current<-r()) {
                        ...
                        o = (G + s) / G;
                        var a = k.positions.current - s * (1 - o) / 2, l =- r() - G / 2;
                        k.positions.current = l > a || 0 >= o ? l : a
                    }
                }
                if (t.resistance && "100%" === t.resistance && (k.positions.current > 0 && (!t.freeMode || t.freeModeFluid) && (k.positions.current = 0), k.positions.current<-r() && (!t.freeMode || t.freeModeFluid) && (k.positions.current =- r())), !t.followFinger)
                    return;
                if (t.moveStartThreshold)
                    if (Math.abs(k.touches.current - k.touches.start) > t.moveStartThreshold || K) {
                        if (!K)
                            return K=!0, void(k.touches.start = k.touches.current);
                            k.setWrapperTranslate(k.positions.current)
                    } else 
                        k.positions.current = k.positions.start;
                    else 
                        k.setWrapperTranslate(k.positions.current);
    ...
    function m(e) {
        if (D && k.swipeReset(), !t.onlyExternal && k.isTouched) {
            ...
            var i = k.positions.diff, n = k.positions.abs, o = k.times.end - k.times.start;
            5 > n && 300 > o && k.allowLinks===!1 && (t.freeMode || 0 === n || k.swipeReset(), t.preventLinks && (k.allowLinks=!0), t.onSlideClick && (k.allowSlideClick=!0)), setTimeout(function() {
                t.preventLinks && (k.allowLinks=!0), t.onSlideClick && (k.allowSlideClick=!0)
            }, 100);
            var s = r();
            if (!k.isMoved && t.freeMode)
                return k.isMoved=!1, t.onTouchEnd && k.fireCallback(t.onTouchEnd, k, e), void k.callPlugins("onTouchEnd");
            if (!k.isMoved || k.positions.current > 0 || k.positions.current<-s)
                return k.swipeReset(), t.onTouchEnd && k.fireCallback(t.onTouchEnd, k, e), void k.callPlugins("onTouchEnd");
            if (k.isMoved=!1, t.freeMode) {
                if (t.freeModeFluid) {
                    var a, l = 1e3 * t.momentumRatio, d = k.velocity * l, p = k.positions.current + d, u=!1, c = 20 * Math.abs(k.velocity) * t.momentumBounceRatio;
                    - s > p && (t.momentumBounce && k.support.transitions ? ( - c > p + s && (p =- s - c), a =- s, u=!0, U=!0) : p =- s), p > 0 && (t.momentumBounce && k.support.transitions ? (p > c && (p = c), a = 0, u=!0, U=!0) : p = 0), 0 !== k.velocity && (l = Math.abs((p - k.positions.current) / k.velocity)), k.setWrapperTranslate(p), k.setWrapperTransition(l), t.momentumBounce && u && k.wrapperTransitionEnd(function() {
            ...
            if ("auto" === t.slidesPerView) {
                for (var h, g = Math.abs(k.getWrapperTranslate()), w = 0, m = 0; m < k.slides.length; m++)
                    if (h = O ? k.slides[m].getWidth(!0, t.roundLengths) : k.slides[m].getHeight(!0, t.roundLengths), w += h, w > g) {
                        f = h;
                        break
                    }
                f > G && (f = G)
    ...
    function v(e) {
        var i=!1;
        do 
            e.className.indexOf(t.noSwipingClass)>-1 && (i=!0), e = e.parentElement;
    ...
    function T(e, i, n) {
        function r() {
            var o =+ new Date, u = o - s;
            a += l * u / (1e3 / 60), p = "toNext" === d ? a > e : e > a, p ? (k.setWrapperTranslate(Math.round(a)), k._DOMAnimating=!0, window.setTimeout(function() {
                r()
        ...
        var o = "to" === i && n.speed >= 0 ? n.speed: t.speed, s =+ new Date;
        if (k.support.transitions ||!t.DOMAnimation)
            k.setWrapperTranslate(e), k.setWrapperTransition(o);
        else {
            var a = k.getWrapperTranslate(), l = Math.ceil((e - a) / o * (1e3 / 60)), d = a > e ? "toNext": "toPrev", p = "toNext" === d ? a > e: e > a;
            if (k._DOMAnimating)
                return;
            r()
        }
    ...
    function x() {
        ...
        if (e)
            for (var t = 0; t < e.length; t++)
                k.h.removeEventListener(e[t], "click", C)
    }
    function b() {
        var e = k.paginationButtons;
        if (e)
            for (var t = 0; t < e.length; t++)
                k.h.addEventListener(e[t], "click", C)
    }
    function C(e) {
        for (var t, i = e.target || e.srcElement, n = k.paginationButtons, r = 0; r < n.length; r++)
            i === n[r] && (t = r);
        k.swipeTo(t)
    }
    function L() {
    ...
    if (window.getComputedStyle || (window.getComputedStyle = function(e) {
        ...
        for (var R in N)
            if (R in t && "object" == typeof t[R])
                for (var F in N[R])
                    F in t[R] || (t[R][F] = N[R][F]);
            else 
                R in t || (t[R] = N[R]);
        k.params = t, t.scrollContainer && (t.freeMode=!0, t.freeModeFluid=!0), t.loop && (t.resistance = "100%");
        var O = "horizontal" === t.mode, z = ["mousedown", "mousemove", "mouseup"];
        k.browser.ie10 && (z = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]), k.browser.ie11 && (z = ["pointerdown", "pointermove", "pointerup"]), k.touchEvents = {
        ...
        for (var V = k.container.childNodes.length - 1; V >= 0; V--)
            if (k.container.childNodes[V].className)
                for (var B = k.container.childNodes[V].className.split(/\s+/), H = 0; H < B.length; H++)
                    B[H] === t.wrapperClass && (P = k.container.childNodes[V]);
        k.wrapper = P, k._extendSwiperSlide = function(e) {
            return e.append = function() {
                ...
                for (var t, i = k.slides.length - 1; i >= 0; i--)
                    e === k.slides[i] && (t = i);
                return t
            }, e.isActive = function() {
            ...
            for (var n = 0; n < k.wrapper.childNodes.length; n++)
                if (k.wrapper.childNodes[n].className)
                    for (var r = k.wrapper.childNodes[n].className, o = r.split(/\s+/), l = 0; l < o.length; l++)
                        o[l] === t.slideClass && k.slides.push(k.wrapper.childNodes[n]);
            for (n = k.slides.length - 1; n >= 0; n--)
                k._extendSwiperSlide(k.slides[n]);
            ...
            for (var e = k.slides.length - 1; e >= 0; e--)
                k.slides[e].remove()
            ...
            if ("[object Array]" === Object.prototype.toString.call(e))
                ...
                "[object String]" === Object.prototype.toString.call(e) ? t["on" + e] && k.fireCallback(t["on" + e], arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]) : e(arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
        ...
        k.callPlugins = function(e, t) {
            ...
            var n = k.h.getWidth(k.container, !1, t.roundLengths), r = k.h.getHeight(k.container, !1, t.roundLengths);
            if (n !== k.width || r !== k.height || e) {
                ...
                if (e && k.calcSlides(i), "auto" === t.slidesPerView) {
                    ...
                    for (k.snapGrid = [], k.slidesGrid = [], a = 0, u = 0; u < k.slides.length; u++) {
                        ...
                        var w = O ? o: s;
                        if (t.centeredSlides) {
                            var m = u === k.slides.length - 1 ? 0: k.slides[u + 1].getWidth(!0, t.roundLengths), v = u === k.slides.length - 1 ? 0: k.slides[u + 1].getHeight(!0, t.roundLengths), S = O ? m: v;
                            if (w > G) {
                                if (t.slidesPerViewFit)
                                    k.snapGrid.push(p + k.wrapperLeft), k.snapGrid.push(p + w - G + k.wrapperLeft);
                                else 
                                    for (var T = 0; T <= Math.floor(w / (G + k.wrapperLeft)); T++)
                                        k.snapGrid.push(0 === T ? p + k.wrapperLeft : p + k.wrapperLeft + G * T);
                                k.slidesGrid.push(p + k.wrapperLeft)
                            } else 
                                k.snapGrid.push(g), k.slidesGrid.push(g);
                            g += w / 2 + S / 2
                        } else {
                            if (w > G)
                                if (t.slidesPerViewFit)
                                    k.snapGrid.push(p), k.snapGrid.push(p + w - G);
                                else if (0 !== G)
                                    for (var y = 0; y <= Math.floor(w / G); y++)
                                        k.snapGrid.push(p + G * y);
                                else 
                                    k.snapGrid.push(p);
                            else 
                                k.snapGrid.push(p);
                    ...
                    c.style.width = "", c.style.height = "", l = k.slides[0].getWidth(!0, t.roundLengths), d = k.slides[0].getHeight(!0, t.roundLengths), I = O ? l : d, c.style.width = l + "px", c.style.height = d + "px", A = O ? l : d;
                else {
                    if (t.calculateHeight) {
                        for (a = 0, d = 0, O || (k.container.style.height = ""), c.style.height = "", u = 0; u < k.slides.length; u++)
                            k.slides[u].style.height = "", a = Math.max(k.slides[u].getHeight(!0), a), O || (d += k.slides[u].getHeight(!0));
                        s = a, k.height = s, O ? d = s : (G = s, k.container.style.height = G + "px")
                    } else 
                        s = O ? k.height : k.height / t.slidesPerView, t.roundLengths && (s = Math.round(s)), d = O ? k.height : k.slides.length * s;
                    for (o = O ? k.width / t.slidesPerView : k.width, t.roundLengths && (o = Math.round(o)), l = O ? k.slides.length * o : k.width, A = O ? o : s, t.offsetSlidesBefore > 0 && (O ? k.wrapperLeft = A * t.offsetSlidesBefore : k.wrapperTop = A * t.offsetSlidesBefore), t.offsetSlidesAfter > 0 && (O ? k.wrapperRight = A * t.offsetSlidesAfter : k.wrapperBottom = A * t.offsetSlidesAfter), t.offsetPxBefore > 0 && (O ? k.wrapperLeft = t.offsetPxBefore : k.wrapperTop = t.offsetPxBefore), t.offsetPxAfter > 0 && (O ? k.wrapperRight = t.offsetPxAfter : k.wrapperBottom = t.offsetPxAfter), t.centeredSlides && (O ? (k.wrapperLeft = (G - A) / 2, k.wrapperRight = (G - A) / 2) : (k.wrapperTop = (G - A) / 2, k.wrapperBottom = (G - A) / 2)), O ? (k.wrapperLeft > 0 && (c.style.paddingLeft = k.wrapperLeft + "px"), k.wrapperRight > 0 && (c.style.paddingRight = k.wrapperRight + "px")) : (k.wrapperTop > 0 && (c.style.paddingTop = k.wrapperTop + "px"), k.wrapperBottom > 0 && (c.style.paddingBottom = k.wrapperBottom + "px")), I = O ? l + k.wrapperRight + k.wrapperLeft : d + k.wrapperTop + k.wrapperBottom, t.cssWidthAndHeight || (parseFloat(l) > 0 && (c.style.width = l + "px"), parseFloat(d) > 0 && (c.style.height = d + "px")), p = 0, k.snapGrid = [], k.slidesGrid = [], u = 0; u < k.slides.length; u++)
                        k.snapGrid.push(p), k.slidesGrid.push(p), p += A, t.cssWidthAndHeight || (parseFloat(o) > 0 && (k.slides[u].style.width = o + "px"), parseFloat(s) > 0 && (k.slides[u].style.height = s + "px"))
                    }
            ...
            var e = k.h.removeEventListener, i = "wrapper" === t.eventTarget ? k.wrapper: k.container;
        ...
        k.swipeNext = function(e) {
            ...
            var i = k.getWrapperTranslate(), n = i;
            if ("auto" === t.slidesPerView) {
            ...
            var e, i = k.getWrapperTranslate(), n = A * t.slidesPerGroup;
            if ( - r(), "auto" === t.slidesPerView) {
                ...
                e = 0 > i ? Math.round(i / n) * n : 0;
            return t.scrollContainer && (e = 0 > i ? i : 0), e<-r() && (e =- r()), t.scrollContainer && G > A && (e = 0), e === i?!1 : (T(e, "reset"), !0)
            ...
            if (!(e > k.slides.length - 1 || 0 > e)) {
                var s;
                return s = "auto" === t.slidesPerView?-k.slidesGrid[e] : - e * A, s<-r() && (s =- r()), s === o?!1 : (n = n===!1?!1 : !0, T(s, "to", {
                    index : e, speed : i, runCallbacks : n
                }), !0)
            }
            ...
            if (k.initialized && 0 !== k.slides.length) {
                ...
                if ("auto" === t.slidesPerView) {
                    if (k.activeIndex = k.slidesGrid.indexOf( - e), k.activeIndex < 0) {
                        ...
                        var n = Math.abs(k.slidesGrid[i] + e), r = Math.abs(k.slidesGrid[i + 1] + e);
                        k.activeIndex = r >= n ? i : i + 1
                    }
                } else 
                    k.activeIndex = Math[t.visibilityFullFit ? "ceil": "round"]( - e / A);
                if (k.activeIndex === k.slides.length && (k.activeIndex = k.slides.length - 1), k.activeIndex < 0 && (k.activeIndex = 0), k.slides[k.activeIndex]) {
                    if (k.calcVisibleSlides(e), k.support.classList) {
                        var o;
                        for (i = 0; i < k.slides.length; i++)
                            o = k.slides[i], o.classList.remove(t.slideActiveClass), k.visibleSlides.indexOf(o) >= 0 ? o.classList.add(t.slideVisibleClass) : o.classList.remove(t.slideVisibleClass);
                        ...
                        for (i = 0; i < k.slides.length; i++)
                            k.slides[i].className = k.slides[i].className.replace(s, "").replace(a, ""), k.visibleSlides.indexOf(k.slides[i]) >= 0 && (k.slides[i].className += " " + t.slideVisibleClass);
                    ...
                    if (t.loop) {
                        ...
                        k.activeLoopIndex = k.activeIndex;
                    ...
                    if (0 !== r.length) {
                        ...
                        if (t.paginationAsRange) {
                            ...
                            for (a = 0; a < l.length; a++)
                                r[l[a]] && (r[l[a]].className += " " + t.paginationVisibleClass);
                            ...
                            t.loop ? r[k.activeLoopIndex] && (r[k.activeLoopIndex].className += " " + t.paginationActiveClass + " " + t.paginationVisibleClass) : r[k.activeIndex].className += " " + t.paginationActiveClass + " " + t.paginationVisibleClass
                    }
                }
            }
            ...
            for (var s = 0; s < k.slides.length; s++) {
                ...
                var a=!1;
                t.visibilityFullFit ? (n>=-e&&-e + G >= o && (a=!0), - e >= n && o>=-e + G && (a=!0)) : (o>-e&&-e + G >= o && (a=!0), n>=-e&&-e + G > n && (a=!0), - e > n && o>-e + G && (a=!0)), a && i.push(k.slides[s])
            }
        ...
        k.startAutoplay = function() {
            if (k.support.transitions) {
                ...
                if (!t.autoplay)
                    return;
                k.callPlugins("onAutoplayStart"), t.onAutoplayStart && k.fireCallback(t.onAutoplayStart, k), et = setInterval(function() {
            ...
            if (k.support.transitions) {
                ...
                et && clearInterval(et), et = void 0, k.callPlugins("onAutoplayStop"), t.onAutoplayStop && k.fireCallback(t.onAutoplayStop, k)
        }, k.loopCreated=!1, k.removeLoopedSlides = function() {
            if (k.loopCreated)
                for (var e = 0; e < k.slides.length; e++)
                    k.slides[e].getData("looped")===!0 && k.wrapper.removeChild(k.slides[e])
            ...
            if (0 !== k.slides.length) {
                ...
                var e, i = "", n = "", r = "", o = k.slides.length, s = Math.floor(k.loopedSlides / o), a = k.loopedSlides%o;
                for (e = 0; s * o > e; e++) {
                    var l = e;
                    if (e >= o) {
                ...
                for (e = 0; a > e; e++)
                    n += S(t.slideDuplicateClass, k.slides[e].outerHTML);
                for (e = o - a; o > e; e++)
                    i += S(t.slideDuplicateClass, k.slides[e].outerHTML);
                var p = i + r + P.innerHTML + r + n;
                for (P.innerHTML = p, k.loopCreated=!0, k.calcSlides(), e = 0; e < k.slides.length; e++)(e < k.loopedSlides || e >= k.slides.length - k.loopedSlides) 
                    && k.slides[e].setData("looped", !0);
            ...
            for (var i = t.loader.slides, n = t.loader.loadAllSlides ? i.length : t.slidesPerView * (1 + t.loader.surroundGroups), r = 0; n > r; r++)
                e += "outer" === t.loader.slidesHTMLType ? i[r] : "<" + t.slideElement + ' class="' + t.slideClass + '" data-swiperindex="' + r + '">' + i[r] + "</" + t.slideElement + ">";
            ...
            var e = t.loader.slides, i = parseInt(k.activeSlide().data("swiperindex"), 10);
            if (!(0 > i || i > e.length - 1)) {
                k.activeLoaderIndex = i;
                var n = Math.max(0, i - t.slidesPerView * t.loader.surroundGroups), r = Math.min(i + t.slidesPerView * (1 + t.loader.surroundGroups) - 1, e.length - 1);
                if (i > 0) {
                    var o =- A * (i - n);
...
Swiper.prototype = {
    ...
    wrapperTransitionEnd: function(e, t) {
        "use strict";
        function i() {
            if (e(r), r.params.queueEndCallbacks && (r._queueEndCallbacks=!1), !t)
                for (n = 0; n < s.length; n++)
                    r.h.removeEventListener(o, s[n], i)
        }
        var n, r = this, o = r.wrapper, s = ["webkitTransitionEnd", "transitionend", "oTransitionEnd", "MSTransitionEnd", "msTransitionEnd"];
        if (e)
            for (n = 0; n < s.length; n++)
                r.h.addEventListener(o, s[n], i)
    },
    ...
    h: {
        getWidth: function(e, t, i) {
            ...
            return (isNaN(r) || n.indexOf("%") > 0) && (r = e.offsetWidth - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-left")) - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-right"))), t && (r += parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-left")) + parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-right"))), i ? Math.round(r) : r
        },
        getHeight: function(e, t, i) {
            ...
            return (isNaN(r) || n.indexOf("%") > 0) && (r = e.offsetHeight - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-top")) - parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-bottom"))), t && (r += parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-top")) + parseFloat(window.getComputedStyle(e, null).getPropertyValue("padding-bottom"))), i ? Math.round(r) : r
        },
        getOffset: function(e) {
            "use strict";
            var t = e.getBoundingClientRect(), i = document.body, n = e.clientTop || i.clientTop || 0, r = e.clientLeft || i.clientLeft || 0, o = window.pageYOffset || e.scrollTop, s = window.pageXOffset || e.scrollLeft;
...
}(window.jQuery || window.Zepto), "undefined" != typeof module && (module.exports = Swiper), function(e, t) {
    function i(e) {
    ...
    var r, o, s, a, l, d, p, u, c, f, h = "", g = {
        Webkit: "webkit",
        Moz: "",
        O: "o"
    }, w = window.document, m = w.createElement("div"), v = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, S = {};
    e.each(g, function(e, i) {
        return m.style[e + "TransitionProperty"] !== t ? (h = "-" + e.toLowerCase() + "-", r = i, !1) : void 0
    }), o = h + "transform", S[s = h + "transition-property"] = S[a = h + "transition-duration"] = S[d = h + "transition-delay"] = S[l = h + "transition-timing-function"] = S[p = h + "animation-name"] = S[u = h + "animation-duration"] = S[f = h + "animation-delay"] = S[c = h + "animation-timing-function"] = "", e.fx = {
        ...
        return e.isFunction(n) && (o = n, r = t, n = t), e.isFunction(r) && (o = r, r = t), e.isPlainObject(n) && (r = n.easing, o = n.complete, s = n.delay, n = n.duration), n && (n = ("number" == typeof n ? n : e.fx.speeds[n] || e.fx.speeds._default) / 1e3), s && (s = parseFloat(s) / 1e3), this.anim(i, n, r, o, s)
    }, e.fn.anim = function(n, r, h, g, w) {
        var m, T, y, x = {}, b = "", C = this, L = e.fx.transitionEnd, E=!1;
        if (r === t && (r = e.fx.speeds._default / 1e3), w === t && (w = 0), e.fx.off && (r = 0), "string" == typeof n)
            x[p] = n, x[u] = r + "s", x[f] = w + "s", x[c] = h || "linear", L = e.fx.animationEnd;
        else {
            T = [];
            for (m in n)
                v.test(m) ? b += m + "(" + n[m] + ") " : (x[m] = n[m], T.push(i(m)));
            b && (x[o] = b, T.push(o)), r > 0 && "object" == typeof n && (x[s] = T.join(", "), x[a] = r + "s", x[d] = w + "s", x[l] = h || "linear")
        }
        return y = function(t) {
            if ("undefined" != typeof t) {
                ...
                e(this).unbind(L, y);
            E=!0, e(this).css(S), g && g.call(this)
        }, r > 0 && (this.bind(L, y), setTimeout(function() {
            E || y.call(C)
        }, 1e3 * r + 25)), this.size() && this.get(0).clientLeft, this.css(x), 0 >= r && setTimeout(function() {
            C.each(function() {
                y.call(this)
            })
        }, 0), this
